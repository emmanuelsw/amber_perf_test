...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber Perf Test web application."
  #
  #
  ...
  #
  # settings.secret_key_base= lwNguY7x_6Bo5arKtHARtlwJNcKS4C9absITH6_wQF8
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amber-perf-test.log", "w"))
  #
  #
end
